...
public class KlingonTextTest
{
    KlingonText _klingonText;
    ...
    public void Initialize()
    {
        ...
        this._klingonText = new KlingonText(textA);
    }

    [Test]
    public void MustGetPrepositionCount()
    {
        Assert.AreEqual(63, this._klingonText.PrepositionCount);
    }

    [Test]
    public void MustGetVerbCount()
    {
        Assert.AreEqual(26, this._klingonText.VerbCount);
    }

    [Test]
    public void MustGetFirstPersonVerbCount()
    {
        Assert.AreEqual(23, this._klingonText.VerbInFirstPersonCount);
    }
    ...
    public void MustGetVocabulary()
    {
        ...
        Assert.AreEqual(expectedVocabulary, this._klingonText.Vocabulary);
    }

    [Test]
    public void MustGetBeautifulDistinctNumbersCount()
    {
        Assert.AreEqual(126, this._klingonText.BeautifulDistinctNumbers.Length);
    }
}
