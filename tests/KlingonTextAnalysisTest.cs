...
public class KlingonTextAnalysisTest
{
    ...
    public void Initialize()
    {
        ...
        _KlingonTextAnalysis = new KlingonTextAnalysis(textA);
    }

    [Test]
    public void MustGetEmptyDataOnEmptyOrInsufficientText()
    {
        _KlingonTextAnalysis = new("");
        Assert.AreEqual(0, _KlingonTextAnalysis.Prepositions.Length);
        Assert.AreEqual(0, _KlingonTextAnalysis.Verbs.Length);
        Assert.AreEqual(0, _KlingonTextAnalysis.VerbsInFirstPerson.Length);
        Assert.AreEqual(0, _KlingonTextAnalysis.Vocabulary.Length);
        Assert.AreEqual(0, _KlingonTextAnalysis.BeautifulNumbers.Length);
    }

    [Test]
    public void MustGetPrepositions()
    {
        Assert.AreEqual(63, _KlingonTextAnalysis.Prepositions.Length);
    }

    [Test]
    public void MustGetVerbs()
    {
        Assert.AreEqual(26, _KlingonTextAnalysis.Verbs.Length);
    }

    [Test]
    public void MustGetVerbsInFirstPerson()
    {
        Assert.AreEqual(23, _KlingonTextAnalysis.VerbsInFirstPerson.Length);
    }
    ...
    public void MustGetVocabulary()
    {
        ...
        Assert.AreEqual(expectedVocabulary.Length, _KlingonTextAnalysis.Vocabulary.Length);
    }

    [Test]
    public void MustGetBeautifulNumbers()
    {
        Assert.AreEqual(126, _KlingonTextAnalysis.BeautifulNumbers.Length);
    }
}
