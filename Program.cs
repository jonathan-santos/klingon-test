...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Text A beautiful distinct numbers quantity: {textA.BeautifulDistinctNumbersInText.Length}");
        ...
        Console.WriteLine($"Text B beautiful distinct numbers quantity: {textB.BeautifulDistinctNumbersInText.Length}");
    }
}
